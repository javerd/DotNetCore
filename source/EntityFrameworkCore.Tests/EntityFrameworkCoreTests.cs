...
namespace DotNetCore.EntityFrameworkCore.Tests
{
    ...
    public class EntityFrameworkCoreTests
    {
        ...
        public void Tests()
        {
            ...
            var result2 = _repository.Queryable.Project<FakeEntity, FakeEntityModel>().GridAsync(new GridParameters()).Result;
            var result3 = _repository.SpecifyAsync(new FakeSpecification()).Result;
